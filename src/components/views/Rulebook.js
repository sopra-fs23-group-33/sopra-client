...
const Rulebook = () => {
    ...
    return (
        ...
        <div className="round wrapper" >
            ...
            <p>
                At the beginning of the game, you are allocated 1000 coins to kickstart your investment banking career.
            ...
            <p>
                ...
                of coins you are willing to risk, and the direction of the bet. If you go LONG, you are
                betting that the currency will follow an upward trend in the near future. If you place a SHORT order,
            ...
            <ul>
                ...
                <li><b>Plus 100, Plus 200, Plus 500, Plus 1000</b>: These Power-Ups add the specified number of coins into your account. As simple as that.</li>
                ...
                <li><b>Guardian</b>: Use it if peasants try to take your riches away - it protects you against <b>Robin Hood</b>.</li>
                <br/>
                <li><b>Hacker</b>: Robin', but without the Hood. You steal from the leading player and keep it to yourself.</li>
                <li><b>Cyber Security</b>: One more tool to keep the money where it belongs. It renders the <b>Hacker</b> useless.</li>
                <br/>
                ...
                <li><b>Incendiary</b>: Some people just want to see the world burn. An unlucky player sees their balance drop to flat 0.</li>
            </ul>
