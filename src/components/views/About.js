...
const About = () => {
    ...
    return (
        <div className="round base-container">
            ...
            <p>
                Gamification features such as power-ups, events, round structure and time pressure make for an exciting experience. It's even more
                exciting if played in multiplayer mode with some friends! For a detailed description of how the game works, check
                out the Rulebook:
            </p>
